...
# MAGIC %sql
# MAGIC drop table scd2Demo;

# COMMAND ----------

dbutils.fs.rm("dbfs:/user/hive/warehouse/FileStore/",True)
...
joinDf = sourceDF.join(targetDF, (sourceDF.pk1 == targetDF.pk1) & (sourceDF.pk2 == targetDF.pk2) & (targetDF.active_status == 'Y'),"leftouter") \
    .select(sourceDF["*"],\

...
base_dir = "/FileStore/dataset_ch8"
...
dbutils.fs.rm("dbfs:/FileStore/dataset_ch8/invoices/invoices_2021.csv")

# COMMAND ----------

# MAGIC %fs ls /FileStore/dataset_ch8/invoices
...
dbutils.fs.rm("dbfs:/user/hive/warehouse/demo_db.db/invoices_raw",True)

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS demo_db.invoices_raw(
# MAGIC   InvoiceNo int,
...
# MAGIC %sql
# MAGIC SELECT * FROM demo_db.invoices_raw
...
# MAGIC %fs cp FileStore/dataset_ch8/invoices_2021.csv FileStore/dataset_ch8/invoices
...
# MAGIC %sql
# MAGIC ALTER TABLE demo_db.invoices_raw ADD COLUMNS (Country string)

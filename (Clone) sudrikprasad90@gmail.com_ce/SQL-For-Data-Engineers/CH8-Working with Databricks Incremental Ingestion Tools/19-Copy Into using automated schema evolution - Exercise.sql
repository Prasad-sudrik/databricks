...
-- MAGIC %python
-- MAGIC dbutils.fs.rm("dbfs:/FileStore/dataset_ch8/invoices/invoices_2021.csv")
...
-- MAGIC %python
-- MAGIC dbutils.fs.rm("dbfs:/user/hive/warehouse/demo_db.db/invoices_raw",True)
...
CREATE TABLE IF NOT EXISTS demo_db.invoices_raw;
...
DESCRIBE EXTENDED demo_db.invoices_raw;
...
COPY INTO demo_db.invoices_raw
FROM "dbfs:/FileStore/dataset_ch8/invoices"
FILEFORMAT = CSV
...
select * from demo_db.invoices_raw

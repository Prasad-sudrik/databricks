...
select * from demo_db.daily_sales_uk_2022

-- COMMAND ----------

describe extended demo_db.daily_sales_uk_2022
...
select * from demo_db.customers where customer_id=15311

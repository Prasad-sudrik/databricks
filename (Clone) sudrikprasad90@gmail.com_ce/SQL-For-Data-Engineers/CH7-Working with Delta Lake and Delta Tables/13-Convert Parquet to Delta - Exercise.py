...
# spark.sql("CREATE VOLUME IF NOT EXISTS demo_db.files")
...
staging_df.write.format("parquet").mode("overwrite").partitionBy("Year").save("dbfs:/user/hive/warehouse/demo_db.db/files/fire_calls_tbl")
...
# MAGIC %fs
# MAGIC ls dbfs:/user/hive/warehouse/demo_db.db/files/fire_calls_tbl/Year=2000/
...
# MAGIC %sql
# MAGIC CONVERT TO DELTA parquet.`dbfs:/user/hive/warehouse/demo_db.db/files/fire_calls_tbl/`
# MAGIC PARTITIONED BY (YEAR INT)

# COMMAND ----------

# MAGIC %fs
# MAGIC ls dbfs:/user/hive/warehouse/demo_db.db/files/fire_calls_tbl/
...
# MAGIC %sql 
# MAGIC DESCRIBE HISTORY delta.`dbfs:/user/hive/warehouse/demo_db.db/files/fire_calls_tbl/`

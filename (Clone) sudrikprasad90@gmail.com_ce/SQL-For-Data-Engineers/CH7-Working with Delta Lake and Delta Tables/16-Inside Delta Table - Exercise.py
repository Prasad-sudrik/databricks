...
(staging_df.write
        .format("delta")
        .mode("overwrite")
        .save("dbfs:/data/fire_calls_tbl")
)

# COMMAND ----------

# MAGIC %fs
# MAGIC ls dbfs:/data/fire_calls_tbl/
...
# MAGIC %fs ls dbfs:/data/fire_calls_tbl/_delta_log/
...
# MAGIC %sql
# MAGIC delete from delta.`dbfs:/data/fire_calls_tbl` where 
# MAGIC CallFinalDisposition = "Duplicate"
...
# MAGIC %sql
# MAGIC DESCRIBE HISTORY delta.`dbfs:/data/fire_calls_tbl/`

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM JSON.`dbfs:/data/fire_calls_tbl/_delta_log/00000000000000000001.json`
...
# MAGIC %fs ls dbfs:/data/fire_calls_tbl/
